...
const AddAccount = () => {
  ...
  const getUniqueValues = (key) => {
    return [...new Set(userList.map(item => item[key]))].filter(Boolean);
  };
  ...
  return (
    <>
      <Sidebar />
      <div className="lg:pl-[90px] pt-14 pr-2 pb-2 max-sm:pt-1 max-sm:pl-2 max-lg:pl-[90px] bg-gray-50 min-h-screen">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div>
                    ...
                    >
                      ...
                      {getUniqueValues('designation').map((value, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-800">{userList.length}</h2>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-800">{filteredUsers.length}</h2>
                  <p className="text-gray-600 text-sm">Filtered Users</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-800">{getUniqueValues('designation').length}</h2>
                  <p className="text-gray-600 text-sm">Designations</p>
                </div>
              </div>
            </div>
          </div>
                    ...
                    currentUsers.map((user, index) => (
                      <tr key={user._id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <img src={user.profilePic || '/default-avatar.png'} alt="Profile" className="h-10 w-10 object-cover rounded-full" />
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{user.name}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{user.fatherName}</td>
