...
import { FaSearch, FaPlus, FaEye, FaEdit, FaTrash, FaFilter, FaFileExport, FaTimes, FaDownload, FaChevronLeft, FaChevronRight } from "react-icons/fa";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-800">{studentList.length}</h2>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-800">{filteredStudents.length}</h2>
                    ...
                    currentStudents.map((student, index) => (
                      <tr key={student._id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <img src={student.studentPic} alt="Student" className="h-10 w-10 object-cover rounded-full" />
                        </td>
