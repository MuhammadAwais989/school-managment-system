  ...
  return (
    <>
      {TeachersData.map((items) => (
        <div id="card" key={items.type} className="lg:w-[23.8%] w-60 max-sm:w-[47%] sm:w-[47%] max-[460px]:w-full h-24  bg-white border rounded-md shadow-sm hover:shadow-md transition-shadow flex items-center justify-between px-5 mt-3">
